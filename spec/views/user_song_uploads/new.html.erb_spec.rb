...
describe "user_song_uploads/new.html.erb" do
  before(:each) do
    assign(:user_song_upload, stub_model(UserSongUpload,
      :user_id => 1,
      :title => "MyString",
      :artist => "MyString",
      :file => "MyString"
  ...
  it "renders new user_song_upload form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => user_song_uploads_path, :method => "post" do
